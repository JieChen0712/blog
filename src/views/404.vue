<template>
  <div class="notfound">
    <nav class="shelf">
      <router-link to="/blog/home" class="book home-page" >Home page</router-link>
      <router-link to="/blog/home" class="book about-us">About us</router-link>
      <router-link to="/blog/home" class="book contact">Contact</router-link>
      <a class="book faq" @click="back">Back</a>
